...
namespace Xc.UnitTests.Domain.Base.Tests
{
    ...
    public class ValueObjectBaseTest
    {
        ...
        public void TestEquals()
        {
            ...
            Assert.IsFalse(_address1.Equals(new Student()));
        ...
        public void TestGetHashCode()
        {
            Assert.IsTrue(_address1.GetHashCode() == _address2.GetHashCode(),
                "_address1.GetHashCode() == _address2.GetHashCode()");
            Assert.IsFalse(_address1.GetHashCode() == _address3.GetHashCode(),
                "_address1.GetHashCode() == _address3.GetHashCode()");
        }
